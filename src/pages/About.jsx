...
import aboutImg from "../assets/r3.jpg";
import Popular from "../components/PopularAuthors"; // 👈 Import the Popular section

const About = () => {
  return (
    <div
      className="min-h-screen pt-28 px-4 md:px-0 mb-7 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100"
      style={{
        fontFamily:
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <p className="text-lg mb-4">
              Welcome to our NairobiEstate! We created this platform for readers,
